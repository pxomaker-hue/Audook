...
class MainWindow(QMainWindow):
 ...
 self._library_button.setText("📚 Library")
 ...
 self._queue_button.setText("🎵 Queue")
 ...
 self._bookmarks_button.setText("🔖 Bookmarks")
 ...
 self._status_bar.setText("Loading libraries...")
 ...
 self._status_bar.setText(f"Connected to {server.name}")
 ...
 self._is_loading = True
 self._status_bar.setText(f"Loading audiobooks from {library.name}...")
 ...
 self._status_bar.setText(f"{len(audiobooks)} audiobooks loaded")
 ...
 """Search audiobooks"""
 self._is_loading = True
 self._status_bar.setText(f"Searching for '{query}'...")
 ...
 self._status_bar.setText(f"Found {len(audiobooks)} results")
 ...
 self._status_bar.setText(f"Downloading {audiobook.title}...")
 
 # TODO: Implement download
 # For now, just show message
 self._status_bar.setText(f"Download started: {audiobook.title}")
